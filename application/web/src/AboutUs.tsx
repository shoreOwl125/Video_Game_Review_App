  ...
  return (
    <div className="about-us">
      ...
      <p className="intro">
        ...
        working to create an amazing web application that helps users review and
        find their favorite games.
      </p>
      ...
      <div className="meeting-info" style={{ marginTop: "40px" }}>
        <p>
          <b>Meeting Times: </b>Monday after class and Wednesday 8pm
        </p>
        <p>
          <b>Meeting Channel: </b>Discord
        </p>
        <p>
          <a
            href="https://docs.google.com/document/d/1KCSDD8qNFlS1uTHWu4Y3orfyIT6Mm_eD91IicC1Htqw/edit?usp=sharing"
            target="_blank"
          >
            View the Team Skills and Study Schedule
          </a>
        </p>
      </div>
    </div>
