...
describe('User Registration, Login, Logout, and Profile API Tests', () => {
  ...
  it('should log in the user with correct credentials and return a token in cookies', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // First, register the user
      yield (0, supertest_1.default)(app_1.default).post('/register').send({
        name: 'John Doe',
  ...
  it('should log out the user and clear the JWT token from cookies', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // Log in the user first to have a valid JWT token
      yield (0, supertest_1.default)(app_1.default).post('/login').send({
        email: uniqueEmail,
        password: 'password123',
      })
